...
func init() {
	...
	CVEQueryCmd.Flags().StringArrayVarP(&AttackVector, "attackVector", "r", []string{}, "Attack Vector: [Network, Adjacent, Local, Physical]")
	CVEQueryCmd.Flags().StringArrayVarP(&Status, "status", "u", []string{}, "CVE Status: [Vulnerable, Needs Review, Won't fix, Resolved, Unaffected, Ignored]")
